...
export type CloudStorage = {
    setItem: (key: string, value: string, clb?: (param: null | Error, stored: boolean) => void) => void;
    getItem: (key: string, clb?: (param: null | Error, value: string) => void) => void;
    getItems: (keys: string[], clb?: (param: null | Error, values: string[]) => void) => void;
    removeItem: (key: string, clb?: (param: null | Error, removed: boolean) => void) => void;
    removeItems: (keys: string[], clb?: (param: null | Error, removed: boolean) => void) => void;
...
type Telegram = {
    ...
    shareMessage: (msg_id: string, callback?: (status: boolean) => void) => void;
    ...
    onEvent: (eventType: eventType, callback: () => void) => unknown;
    // onEvent(
    ...
    showPopup: (params: popupParams, clb?: (id?: string | number) => void) => void;
    showConfirm: (
        message: string,
